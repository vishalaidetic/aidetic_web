...
export const metadata = {
  title: 'Data Flash | Aidetic',
  description: 'Data Flash — An AI-powered analytics agent at your fingertips. Instant answers, automated insights, and enterprise-grade security.',
}

export default async function DataFlashPage() {
  const content = await getPageContent<any>('data-flash')
